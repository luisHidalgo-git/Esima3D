...
public class BookRespawnManager : MonoBehaviour
{
    ...
    public Transform libros1; // Carpeta Libros1
    public Transform libros2; // Carpeta Libros2
    public Transform libros3; // Carpeta Libros3
    ...
    void RespawnBooks()
    {
        // Asumimos que cada carpeta tiene 8 hijos (Libro1...Libro8)
        int totalLibros = libros1.childCount;

        for (int i = 0; i < totalLibros; i++)
        {
            // Obtener las tres posibles posiciones del mismo libro
